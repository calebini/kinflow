...
KINFLOW_REASON_CODES_CANONICAL.md (Master Cut v1.0.6)
# KINFLOW_REASON_CODES_CANONICAL.md

version: v1.0.6
status: canonical
owner: kinflow
last_updated_utc: 2026-04-06T23:12:00Z
...
- terminal_default: false
- resumable: true
- resumable_via: reconcile transition only

- FAILED_ACCEPTED_UNVERIFIED_TIMEOUT
- class: permanent
- retry_eligible_default: false
- terminal_default: true
- resumable: false
...
reason_codes:
  ...
  - code: FAILED_ACCEPTED_UNVERIFIED_TIMEOUT
    class: permanent
    retry_eligible_default: false
    terminal_default: true
    resumable: false
